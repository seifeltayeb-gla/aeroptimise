function [x_c,z_c,z_uc,z_lc] = PARSECpts12(p_u, p_k, x_f)
%
%PARSECpts12 calculates the z-coordiantes of an aerofoil given 12 PARSEC parameters
%
%
...
%
%   INPUT:
%           1- p_u: The known PARSEC12 parameters that can be found by
...
%% Coefficient Calculation: C_up X a_up =b_up ==>  a_up =(C_up)^-1 X b_up
    ...
    z_uc = zeros(length(x_f),1); z_lc = zeros(length(x_f),1); % empty arrays for z
